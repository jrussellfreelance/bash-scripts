...
wget -P /Users/yale/Desktop/first-install-downloads/ https://update.tryshift.com/download/version/3.7.2/osx_64.dmg # Shift
​
tput setaf 5; echo 🦊 Downloading Blue Sherpa Microphone
wget -P /Users/yale/Desktop/first-install-downloads/ http://software.bluedesigns.com/blue/BlueSherpa-20190312.pkg # Blue Sherpa
​
tput setaf 5; echo 🦊 Downloading Blue Sherpa Microphone
wget -P /Users/yale/Desktop/first-install-downloads/ http://update.sonos.com/software/mac/mdcr/SonosDesktopController102.dmg # Sonos
​
​
# install Oh My Zsh
